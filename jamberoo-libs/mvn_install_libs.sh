...
mvn install:install-file -DgroupId=jamberoo -DartifactId=gluegen-rt -Dversion=1.0 -Dpackaging=jar -Dfile=./gluegen-rt.jar
mvn install:install-file -DgroupId=jamberoo -DartifactId=gluegen-rt-natives-macosx-universal -Dversion=1.0 -Dpackaging=jar -Dfile=./gluegen-rt-natives-macosx-universal.jar
...
mvn install:install-file -DgroupId=jamberoo -DartifactId=jocl-natives-macosx-universal -Dversion=1.0 -Dpackaging=jar -Dfile=./jocl-natives-macosx-universal.jar
mvn install:install-file -DgroupId=jamberoo -DartifactId=jogamp-fat -Dversion=1.0 -Dpackaging=jar -Dfile=./jogamp-fat.jar
mvn install:install-file -DgroupId=jamberoo -DartifactId=jogl-all -Dversion=1.0 -Dpackaging=jar -Dfile=./jogl-all.jar
mvn install:install-file -DgroupId=jamberoo -DartifactId=jogl-all-natives-macosx-universal -Dversion=1.0 -Dpackaging=jar -Dfile=./jogl-all-natives-macosx-universal.jar
