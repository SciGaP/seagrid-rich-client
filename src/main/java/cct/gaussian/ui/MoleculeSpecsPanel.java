 ...
 * @version 1.0
 */
public class MoleculeSpecsPanel
    extends JScrollPane {

   boolean newInput = true;
   JTextArea jTextArea1 = new JTextArea();

   public MoleculeSpecsPanel() {
      try {
         jbInit();
      }
      catch (Exception ex) {
   ...
   private void jbInit() throws Exception {
      ...
      jTextArea1.setText("Molecule Specifications are here");
      jTextArea1.setColumns(60);
      jTextArea1.setRows(10);
      jTextArea1.addMouseListener(new
                                  MoleculeSpecsPanel_jTextArea1_mouseAdapter(this));
...
class MoleculeSpecsPanel_jTextArea1_mouseAdapter
    extends MouseAdapter {
   private MoleculeSpecsPanel adaptee;
   MoleculeSpecsPanel_jTextArea1_mouseAdapter(MoleculeSpecsPanel adaptee) {
