...
public class Link0Panel
   ...
   private void jbInit() throws Exception {
      ...
      jTextArea1.setText("Link 0 Commands are Here");
      jTextArea1.setRows(2);
      jTextArea1.addMouseListener(new Link0Panel_jTextArea1_mouseAdapter(this));
...
class Link0Panel_jTextArea1_mouseAdapter
    extends MouseAdapter {
   private Link0Panel adaptee;
   Link0Panel_jTextArea1_mouseAdapter(Link0Panel adaptee) {
