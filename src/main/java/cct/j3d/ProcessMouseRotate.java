 ...
 * @version 1.0
 */
public class ProcessMouseRotate
    extends MouseRotate {
  ...
  private java.util.List<MouseRotationListener> listeners = new ArrayList<MouseRotationListener> ();

  /**
   * Creates a rotate behavior given the transform group.
   * @param transformGroup The transformGroup to operate on.
   */
  public ProcessMouseRotate(TransformGroup transformGroup) {
   ...
   */
  public ProcessMouseRotate(int flags) {
    super(flags);
  }

  public void addMouseRotationListener(MouseRotationListener listener) {
    listeners.add(listener);
  }

  public void removeMouseRotationListener(MouseRotationListener listener) {
  ...
  public void processStimulus(Enumeration criteria) {
    ...
    if (listeners.size() > 0) {
      ...
      MouseRotationEvent mouseRotationEvent = new MouseRotationEvent(t3d);
      for (int i = 0; i < listeners.size(); i++) {
        listeners.get(i).MouseRotated(mouseRotationEvent);
      }
    }
  }
  ...
  public ProcessMouseRotate(Java3dUniverse parent, TransformGroup transformGroup) {
    super(transformGroup);
    dad = parent;
  }
