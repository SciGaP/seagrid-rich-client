 ...
 * @version 1.0
 */
public interface ClientProgramInterface {
  void enableInputFile(boolean enable);

  void enableLocalDir(boolean enable);

  String getCommandsAsString() throws Exception;
  ...
  void setRemoteFileChooser(FileChooserInterface fci);
  ...
  void setJobDescription(JobDescription job) throws Exception;
}
