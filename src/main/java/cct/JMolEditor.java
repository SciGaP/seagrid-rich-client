 ...
 * @version 1.0
 * @deprecated Use JamberooMolecularEditor class instead
 */
@Deprecated
public class JMolEditor implements ActionListener {
  ...
  private Set<JamberooFrame> windows = new LinkedHashSet<JamberooFrame>();
  static final Logger logger = Logger.getLogger(JMolEditor.class.getCanonicalName());

  /**
   * Construct and show the application.
   */
  public JMolEditor(String[] args) {

    System.err.println(JMolEditor.class.getCanonicalName()+" is a deprecated class & is not supported any more");
  ...
  public void actionPerformed(ActionEvent actionEvent) {
    ...
    if (arg.equals(JAMBEROO_NEW_EDITOR_ACTION_COMMAND)) {
      JamberooFrame frame = createJamberooInstance("Jamberoo Molecular Editor", null);
      windows.add(frame);
      frame.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
      addNewEditorMenuItem(frame);
      centerOnScreen(frame);
