...
public class YesNoDialog
   ...
   public YesNoDialog(Frame parent, String Title) {
      super(parent, "Choose Yes or No", true);
  ...
  public void actionPerformed(ActionEvent ae) {
      if (ae.getActionCommand().toString().equals("Yes")) {
         pressedYes = true;
      }
      else if (ae.getActionCommand().toString().equals("No")) {
         pressedYes = false;
      }
      setVisible(false);
   }
