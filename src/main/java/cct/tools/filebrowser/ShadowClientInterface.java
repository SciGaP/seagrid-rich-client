 ...
 * @version 1.0
 */
public interface ShadowClientInterface {
   Component getComponent();
   void setKnownHosts(String[] hosts);
   void setFileBrowser(String host, String username, FileBrowserInterface file_browser);
}
