 ...
 * @version 1.0
 */
public class FileBrowserTableModel
    extends AbstractTableModel {
   String[] columnNames = null;
   boolean DEBUG = true;
   Object[][] data = null;
   static final Logger logger = Logger.getLogger(FileBrowserTableModel.class.getCanonicalName());

   public FileBrowserTableModel(Object[][] new_data) {
      data = new_data;
   }
   ...
   public FileBrowserTableModel(List statuses) {
      if (statuses.size() < 1) {
         data = null;
         return;
      }
  ...
  public void setValueAt(Object value, int row, int col) {
      if (DEBUG) {
         logger.info("Setting value at " + row + "," + col + " to " + value + " (an instance of " + value.getClass() + ")");
      }
