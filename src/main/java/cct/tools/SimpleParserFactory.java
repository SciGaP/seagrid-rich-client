 ...
 * @version 1.0
 * @Deprecated Use cct.mdl.MDLMol class instead
 */
@Deprecated
public class SimpleParserFactory {
   ...
   * @return
   * @throws Exception 
   * @Deprecated Use cct.mdl.MDLMol.parseFile method instead
   */
  @Deprecated
  public static MoleculeInterface parseMDLMolfile(String filename,
          MoleculeInterface mol) throws
          Exception {
    String line;
    ...
    try {
      ...
      if ((line = in.readLine()) == null) {
        in.close();
        throw new Exception(
                "parseMDLMolfile: ERROR: Unxpected End of file while reading Line 1");
      }
      ...
      if ((line = in.readLine()) == null) {
        in.close();
        throw new Exception(
                "parseMDLMolfile: ERROR: Unxpected End of file while reading Line 2");
      }
      ...
      if ((line = in.readLine()) == null) {
        in.close();
        throw new Exception(
                "parseMDLMolfile: ERROR: Unxpected End of file while reading Counts line");
      }
      ...
      try {
        ...
        in.close();
        throw new Exception(
                "parseMDLMolfile: ERROR: Error while parsing number of atoms: "
                + e.getMessage());
      }
      ...
      try {
        ...
        in.close();
        throw new Exception(
                "parseMDLMolfile: ERROR: Error while parsing number of bonds: "
                + e.getMessage());
      }
      ...
      for (int i = 0; i < natoms; i++) {
        ...
        try {
          ...
          in.close();
          throw new Exception(
                  "parseMDLMolfile: ERROR: Error while parsing atom: "
                  + (i + 1)
      ...
      for (int i = 0; i < nbonds; i++) {
        ...
        if ((line = in.readLine()) == null) {
          in.close();
          throw new Exception(
                  "parseMDLMolfile: ERROR: Unxpected End of file while reading bond "
                  + (i + 1));
        }
        ...
        try {
          ...
          in.close();
          throw new Exception(
                  "parseMDLMolfile: ERROR: Error while parsing bond: "
                  + (i + 1) + " : "
                  + e.getMessage());
        }
