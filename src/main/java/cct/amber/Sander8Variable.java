...
public class Sander8Variable {
  ...
  static final Logger logger = Logger.getLogger(Sander8Variable.class.getCanonicalName());

  Sander8Variable(String descr, boolean isEnum) {
    Description = descr;
    enumerated = isEnum;
    if (enumerated) {
  ...
  public void addValue(Sander8VariableValue value) {
  ...
  public String getValue() {
    if (enumerated) {
      Sander8VariableValue value = (Sander8VariableValue) Values.get(
              selectedValue);
    ...
    Sander8VariableValue value = (Sander8VariableValue) Values.get(0);
    return value.getValue();
  }
  ...
  public Sander8VariableValue getValue(int n) {
    if (n < 0 || n >= getNumberOfValues()) {
      return null;
    }
    return (Sander8VariableValue) Values.get(n);
  }
  ...
  public void setSelectedIndex(int index) {
    ...
    Sander8VariableValue valid_value = (Sander8VariableValue) Values.get(index);
  ...
  public String setValue(String new_value) {
    ...
    if (enumerated) {
      ...
      for (int i = 0; i < Values.size(); i++) {
        Sander8VariableValue valid_value = (Sander8VariableValue) Values.get(i);
      ...
      try {
        ...
        Sander8VariableValue valid_value = (Sander8VariableValue) Values.get(0);
