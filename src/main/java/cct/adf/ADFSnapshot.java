...
public class ADFSnapshot {
  ...
  private List<ADFAtom> atoms;
  private Map<String, Double> properties = new HashMap<String, Double> (10);

  public ADFSnapshot() {
  }

  public List<ADFAtom> getAtoms() {
    return atoms;
  }

  public void addProperty(String type, double value) {
    properties.put(type, new Double(value));
  }
  ...
  public void setAtoms(ArrayList<ADFAtom> atoms) {
    this.atoms = atoms;
  }
}
