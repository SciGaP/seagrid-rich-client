 ...
 * @version 1.0
 */
public interface GraphicsRendererInterface {
   ...
   void setColorForSelectedAtoms(Color new_color);

   void setLabelForSelectedAtoms(String new_label);

   void setRadiusForSelectedAtoms(float radius);

   void setAtomTypeForSelectedAtoms(String new_atomType);
}
