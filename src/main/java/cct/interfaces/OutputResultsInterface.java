...
public interface OutputResultsInterface {
  ...
  void getSpectrum(double[] x, double[] y, int dim, VIBRATIONAL_SPECTRUM type) throws Exception;

  String[] getAvailPropToChart();

  String getOutputResume();

  void setNormalTermination(boolean yes);

  boolean isNormalTermination();

  double[] getAllTerms(String term);
}
