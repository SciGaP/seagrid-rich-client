...
import cct.tools.filebrowser.SelectionInfoInterface;
...
public interface FileBrowserInterface {
   ...
   void connect(String hostname, String username, char[] password, int port) throws Exception;

   void disconnect();

   void downloadSelected();

   void get(String remote, String local) throws Exception;

   void get(String remote, String local, FileTransferProgress progress) throws Exception;
   ...
   void listUsingFilePattern(String pattern) throws Exception;
   ...
   void setSelectionMode(int mode) throws Exception;
}
