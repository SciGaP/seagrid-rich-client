package org.seagrid.desktop.ui.file.browser; /**
 * YE JIN
...
public class FTPGUI extends javax.swing.JFrame {
	 ...
	 */
	private void localListMouseClicked(MouseEvent evt) {
	 ...
	 */
	private void localListMousePressed(MouseEvent evt) {
	 ...
	 * when right click directory in localList
	 */
	private void localListMouseReleased(MouseEvent evt) {
		if (evt.isPopupTrigger() && localList.getSelectedIndex() != -1) {
			localPopupMenu.show(evt.getComponent(), evt.getX(), evt.getY());
		}
	 ...
	 */
	private void remoteListMouseClicked(MouseEvent evt) {
		if (evt.getClickCount() == 2) {
			enterRemoteDir();
		}
	 ...
	 */
	private void remoteListMousePressed(MouseEvent evt) {
	 ...
	 * when right click directory in remoteList
	 */
	private void remoteListMouseReleased(MouseEvent evt) {
		if (evt.isPopupTrigger() && remoteList.getSelectedIndex() != -1) {
			remotePopupMenu.show(evt.getComponent(), evt.getX(), evt.getY());
		}
	}//event_remoteListMouseReleased

	private void localListMouseDragged(MouseEvent evt) {
	}//event_localListMouseDragged

	/**
	 * when drag directory in remoteList
	 */
	private void remoteListMouseDragged(MouseEvent evt) {
	...
	private void portTextFieldKeyTyped(KeyEvent evt) {// GEN-FIRST:event_portTextFieldKeyTyped
	...
	private JPanel connectPanel; //connect panel
	private javax.swing.JButton disconnectButton;// disconnect button
	private javax.swing.JMenu editMenu; // edit menu
	private JMenuItem exitMenuItem;//exit, file drop dwon menu item
	private JMenuItem exportMenuItem;//export. file drop down menu item
	private javax.swing.JMenu fileMenu;//file menu
	private JPanel headPanel;//head panel
	private javax.swing.JLabel hostLabel;//host label
	private JTextField hostTextField;// host textfield
	private JMenuItem importMenuItem;//import, file drop down menu item
	...
	private JPanel localPanel;//local panel
	...
	private JTextField localTextField;//local textfield
