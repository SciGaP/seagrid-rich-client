package org.seagrid.desktop.connectors.NextcloudAuth;
...
public class ValidateTokenTask {
    ...
    public int ValidateToken(String token) throws IOException {
        ...
        String responseString =  myResponse.get("status").toString();
        int responseInteger = Integer.parseInt(responseString);
