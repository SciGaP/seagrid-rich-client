...
public class SEAGridEvent {
    ...
    public enum SEAGridEventType{
        EXPERIMENT_CREATED, FILE_DOWNLOADED, EXPERIMENT_LAUNCHED, EXPERIMENT_DELETED, FILE_UPLOADED, LOGOUT, EXPERIMENT_CANCELLED, EXPERIMENT_EDIT_REQUEST, EXPERIMENT_UPDATED, EXPERIMENT_CLONED, PROJECT_CREATED
    }
